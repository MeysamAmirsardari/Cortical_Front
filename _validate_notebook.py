"""Validate the generated notebook: JSON well-formed, every code cell
parses as Python, no obvious bugs."""
import ast
import json
from pathlib import Path

NB = Path("/Users/eminent/Projects/Cortical_Front/best_phonemes_cochleagrams.ipynb")
